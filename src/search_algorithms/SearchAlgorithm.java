...
public abstract class SearchAlgorithm {
	...
	public List<Node> porOrdem(List<Node> caminho) { // Utilizo o reverse collections de modo a que a lista de Nodes se apresente da forma desejada e não ao contrário
	...
	public void adicionarElementos(List<Node> caminho, Node[] pai) { // função para adicionar a coleção 

		Collections.addAll(caminho, pai);	
	}
}
